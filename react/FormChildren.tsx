...
import {
  getCountryCodes,
  getSsnLabel,
} from "@src/components/employee/form/SocialSecurityNumberUtils";
...
const FormChildren: FunctionComponent<FormChildrenProps> = ({
  ...
  const { data: degreeOfRelation, basicDataControlLabel: relationshipLabel } =
    fetchBasicData(
    ...
    <>
      ...
      <div className="field col-12">
        {fields.map((field, index) => {
          ...
          return (
            <div
              className={formPageCss.childWrapper}
              key={`fieldset_wrapper_${childKey}`}
            >
              <Fieldset
                ...
                <div className="formgrid grid">
                  ...
                  <div className="field col-10">
                    <ControlledInputText
                      ...
                      isRequired={
                        !child.shape.socialSecurityNumber.isOptional()
                      }
                      disabled={disabled}
                      control={control}
                      errors={errors}
                  ...
                  <div className="field col-6">
                    <ControlledDropdown
                      ...
                      label={
                        relationshipLabel ||
                        t("labels.formPage.children.degreeOfRelation")
                      }
