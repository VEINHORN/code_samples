...
const FormAssignmentSpecificData: FunctionComponent<FormSpecificProps> = ({
  ...
  const renderSelectionField = (input: AssignmentSpecificDataInput) => {
    ...
    const selectionValues = _.isEmpty(
      selectionAssignmentSpecificData.selectionValues,
    )
      ? []
      : selectionAssignmentSpecificData.selectionValues.filter(
          (value) => value.active,
        );
    ...
    return (
      <div
        key={input.assignmentSpecificData.id}
  ...
  const renderDateField = (data: AssignmentSpecificDataInput) => {
    const dateAssignmentSpecificData =
      data.assignmentSpecificData as DateAssignmentSpecificData;
    ...
    return (
      <div
        key={data.assignmentSpecificData.id}
        className="field col-12"
  ...
  const renderDoubleField = (data: AssignmentSpecificDataInput) => {
    const doubleAssignmentSpecificData =
      data.assignmentSpecificData as DoubleAssignmentSpecificData;
    ...
    return (
      ...
      >
        <ControlledInputNumber
          name={`contract.assignmentSpecificData.${data.assignmentSpecificData.id}`}
          label={findLabel(
            data.assignmentSpecificData.labels,
            data.assignmentSpecificData.active,
          )}
          isRequired={data.assignmentSpecificData.required}
          disabled={isFieldDisabled(data.assignmentSpecificData)}
  ...
  const renderIntegerField = (data: AssignmentSpecificDataInput) => {
    const integerAssignmentSpecificData =
      data.assignmentSpecificData as IntegerAssignmentSpecificData;
